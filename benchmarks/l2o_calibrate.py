...
@hydra.main(config_path='configs/unconstrained_qp', config_name='unconstrained_qp_calibrate.yaml')
...
@hydra.main(config_path='configs/sparse_coding', config_name='sparse_coding_calibrate.yaml')
...
@hydra.main(config_path='configs/sine', config_name='sine_calibrate.yaml')
