...
class LISTAmodel(L2WSmodel):
    ...
    def init_params(self):
        ...
        self.sigma_params = (-jnp.ones((self.train_unrolls)) * 10, 
                                -jnp.ones((self.n, self.m, self.train_unrolls)) * 10,
    ...
    def create_end2end_loss_fn(self, bypass_nn, diff_required):
        ...
        def predict(params, input, q, iters, z_star, key, factor):
            ...
            perturb2 = random.normal(w_key, (self.n, self.m, self.train_unrolls))
    ...
    def compute_weight_norm_squared(self, nn_params):
        ...
        num_weights = weight_norms[0].size + weight_norms[1].size + weight_norms[2].size
